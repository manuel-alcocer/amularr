...
| `AMULARR_DOWNLOAD_VOLUME_FACTOR` / `AMULARR_UPLOAD_VOLUME_FACTOR` | `0.25` / `1` | Torznab factors Sonarr/Radarr turn into the `Freeleech75` indexer flag, to score aMule above torrents (see [usage](docs/en/usage.md)) |
